...
export default function DentistBooking(){
...
Complete the form to request your dental appointment
...
className="w-full border rounded-xl p-3 mt-4 h-32 outline-none focus:ring-2 focus:ring-green-400"
...
className="w-full bg-green-600 text-white py-3 rounded-xl mt-6 font-semibold hover:bg-green-700 transition"
...
className="block text-center mt-5 text-green-600 hover:underline"
