...
let filteredDoctors = neurologistDoctors.filter((doctor)=>{
...
placeholder="Search neurologist name..."
...
className="md:hidden mb-5 bg-purple-600 text-white px-5 py-3 rounded-xl flex items-center gap-2"
...
to={`/neurologist-doctor/${doctor.id}`}

className="flex-1 text-center border border-purple-600 text-purple-600 py-3 rounded-xl hover:bg-purple-600 hover:text-white"
...
className="flex-1 text-center bg-purple-600 text-white py-3 rounded-xl hover:bg-purple-700"
