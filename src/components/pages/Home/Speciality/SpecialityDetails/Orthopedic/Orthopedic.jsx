...
import orthopedicDoctors from "./orthopedicData";
...
export default function Orthopedic() {
    ...
    let filteredDoctors = orthopedicDoctors.filter((doctor) => {
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="bg-white rounded-2xl shadow p-4 mb-6 flex items-center gap-3">
                    ...
                    <input
                        ...
                        placeholder="Search Orthopedic Doctor..."
                ...
                <button
                    ...
                    className="md:hidden mb-5 bg-blue-600 text-white px-5 py-3 rounded-xl flex items-center gap-2"
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-3 mt-6">
                                            ...
                                            <Link
                                                ...
                                                to={`/orthopedic-doctors-profile/${doctor.id}`}
